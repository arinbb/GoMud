...
function onAsk(mob, room, eventDetails) {
    ...
    if (question.indexOf("rhapsody") >= 0 || question.indexOf("poodle") >= 0 || question.indexOf("dog") >= 0) {
        ...
        mob.Command("emote makes a note on the legal pad.", 5.5);
    ...
    if (question.indexOf("sherri") >= 0 || question.indexOf("cabot") >= 0 || question.indexOf("owner") >= 0) {
        ...
        mob.Command("say She trusts me in the ring. That matters. Some owners get in the way. Sherri Ann understands her job and my job.", 3.5);
    ...
    if (question.indexOf("handle") >= 0 || question.indexOf("job") >= 0) {
        mob.Command("say I've been handling for fourteen years. Started with obedience, moved into conformation.");
        mob.Command("emote recites this as context, not as a resume.", 2.0);
        ...
        mob.Command("emote looks at her notes.", 8.5);
        return true;
    }
    ...
    if (question.indexOf("win") >= 0 || question.indexOf("best in show") >= 0 || question.indexOf("today") >= 0) {
        ...
        mob.Command("emote goes back to the legal pad.", 8.0);
        return true;
    }
