...
function onAsk(mob, room, eventDetails) {
    ...
    if (question.indexOf("standard") >= 0 || question.indexOf("judging") >= 0 || question.indexOf("judge") >= 0) {
        ...
        mob.Command("emote makes this distinction with the precision of a man who has made it many times and finds it worth making.", 7.0);
    ...
    if (question.indexOf("winner") >= 0 || question.indexOf("best") >= 0 || question.indexOf("who") >= 0) {
        mob.Command("emote looks at you with an expression of practiced neutrality.");
        mob.Command("say I do not speculate about outcomes before judging is complete.", 1.5);
        mob.Command("emote pauses.", 3.0);
        mob.Command("say I will say that there are exceptional animals in this show. Several of them.", 4.5);
        mob.Command("emote appears to have concluded his statement.", 6.0);
        return true;
    }
    ...
    if (question.indexOf("cambridge") >= 0 || question.indexOf("british") >= 0 || question.indexOf("england") >= 0) {
        ...
        mob.Command("emote says this in the tone of someone who does not find this career transition unusual.", 2.0);
    ...
    if (question.indexOf("poodle") >= 0 || question.indexOf("haircut") >= 0) {
        ...
        mob.Command("emote states this simply, as a fact he has stated many times and has never found anything odd about.", 3.5);
...
function onShow(mob, room, eventDetails) {
    ...
    mob.Command("emote waits for the answer with the patience of a man comfortable with precision.", 4.0);
    return true;
}
