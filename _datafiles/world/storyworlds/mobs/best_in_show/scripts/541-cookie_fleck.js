...
function onAsk(mob, room, eventDetails) {
    ...
    if (question.indexOf("feet") >= 0 || question.indexOf("shoes") >= 0) {
        ...
        mob.Command("emote smiles in the warm, uncomplicated way of a woman who has had good things happen to her and knows it.", 5.0);
    ...
    if (question.indexOf("gerry") >= 0 || question.indexOf("husband") >= 0) {
        ...
        mob.Command("say He's just -- he's easy. You know? Not boring-easy. Easy to be with. I didn't know how rare that was when I was younger.", 4.0);
    ...
    if (question.indexOf("winky") >= 0 || question.indexOf("norwich") >= 0) {
        ...
        mob.Command("say He's perfect. I know everyone says their dog is perfect, but -- he just has the right energy for the ring.", 2.0);
