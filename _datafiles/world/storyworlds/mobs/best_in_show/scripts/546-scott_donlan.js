...
function onAsk(mob, room, eventDetails) {
    ...
    if (question.indexOf("agnes") >= 0 || question.indexOf("dog") >= 0 || question.indexOf("show") >= 0) {
        ...
        mob.Command("say Everything is right today. The grooming is right, the light is right, she's calm. Days like this you feel it.", 7.5);
        return true;
    }
    ...
    if (question.indexOf("stefan") >= 0 || question.indexOf("partner") >= 0) {
        ...
        mob.Command("say He can look at a dog in a ring from twenty feet and tell you three things about its structure that you'd miss. I can tell you what time the breed ring starts and where we parked.", 4.5);
    ...
    if (question.indexOf("catalog") >= 0 || question.indexOf("business") >= 0) {
        ...
        mob.Command("emote makes a small note on the clipboard. Always a small note.", 2.0);
...
function onShow(mob, room, eventDetails) {
    ...
    mob.Command("say Hm. Stefan would have a better opinion about this than I do. My instinct is good.", 2.0);
    return true;
}
