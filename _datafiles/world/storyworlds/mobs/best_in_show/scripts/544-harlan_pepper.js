...
function onAsk(mob, room, eventDetails) {
    ...
    if (question.indexOf("nut") >= 0 || question.indexOf("nuts") >= 0) {
    ...
    if (question.indexOf("hubert") >= 0 || question.indexOf("bloodhound") >= 0 || question.indexOf("dog") >= 0) {
        ...
        mob.Command("say He doesn't move fast. He doesn't need to. He just knows things and then goes to them.", 6.5);
        mob.Command("emote is quiet a moment, thinking about Hubert.", 8.5);
        mob.Command("say Good dog.", 10.0);
        return true;
    }

    if (question.indexOf("ventriloquist") >= 0 || question.indexOf("dummy") >= 0 || question.indexOf("show") >= 0) {
        ...
        mob.Command("emote shrugs with the equanimity of a man whose relationship to his work is entirely at peace.", 8.5);
        return true;
    }
    ...
    if (question.indexOf("north carolina") >= 0 || question.indexOf("pine nut") >= 0 || question.indexOf("home") >= 0) {
        ...
        mob.Command("say There's actually a decent pecan grove just outside town. Town was probably named after that.", 6.5);
...
function onShow(mob, room, eventDetails) {
    ...
    mob.Command("emote nods once, slowly, with the expression of a man who sees something and just sees it without needing to explain it.", 4.0);
    return true;
}
