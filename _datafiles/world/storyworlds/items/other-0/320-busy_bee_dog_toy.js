...
function onCommand_use(user, item, room) {
    SendUserMessage(user.UserId(), "<ansi fg=\"yellow\">You squeeze the Busy Bee. It lets out a tired squeak -- halfway between a honk and a wheeze. Somewhere, a small dog perks up its ears.</ansi>");
