...
var BUCK_COMMENTARY = [
    "say You know what I was thinking? A dog show -- this is really just a beauty pageant for dogs. But dogs. Which is -- you know what, that's actually what it is.",
    ...
    "say The handlers -- they've really committed to this. I respect the commitment. Even when I don't understand the thing they've committed to."
];
...
function onAsk(mob, room, eventDetails) {
    ...
    if (question.indexOf("dog") >= 0 || question.indexOf("show") >= 0 || question.indexOf("commentat") >= 0) {
        mob.Command("say I'll be honest with you -- and I say this as a professional broadcaster -- I don't know much about dogs specifically.");
    ...
    if (question.indexOf("trevor") >= 0 || question.indexOf("beckwith") >= 0) {
        mob.Command("say Trevor? Great guy. Very knowledgeable. He's got all the -- he did his homework.");
        ...
        mob.Command("say We have a good back-and-forth. I say a thing, he -- he adds context. It works well.", 5.0);
        mob.Command("emote appears genuinely not to have noticed what Trevor's 'context' usually consists of.", 7.0);
        return true;
    }
    ...
    if (question.indexOf("poodle") >= 0 || question.indexOf("haircut") >= 0) {
        ...
        mob.Command("emote lowers his voice in the manner of a man who has been told by a producer not to pursue this line of thought.", 2.0);
        mob.Command("say Why is the haircut -- that specific haircut -- why is that the show haircut? Is there a reason? Was there ever a reason?", 4.5);
...
function onShow(mob, room, eventDetails) {
    ...
    mob.Command("emote waits. He would genuinely like to know the story.", 4.5);
    return true;
}
